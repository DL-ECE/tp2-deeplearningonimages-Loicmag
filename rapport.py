...
Original file is located at
    https://colab.research.google.com/drive/1kMuLYaZXuNsmiVYXmNCoP72OsiUfld-_
...
def build_image_like_tensor(n_rows:int, n_colums: int, n_channels:int, default_value: int)-> np.ndarray:
  ...
  # YOUR CODE HERE
  return tensor
mat = build_image_like_tensor(2,2,3,255)
print(mat)
...
gray_like = build_image_like_tensor(100,100,3,100)
...
red_like = build_image_like_tensor(rows,columns,channel,0)
red_like[:,:,0] = (255)
green_like = build_image_like_tensor(rows,columns,channel,0)
green_like[:,:,1] = (255)
blue_like = build_image_like_tensor(rows,columns,channel,0)
blue_like[:,:,2] = (255)
...
def normalize_tensor(input_tensor: torch.Tensor) -> torch.Tensor:
    ...
    normalized_dataset = input_tensor/255 #255 values for one pixel
...
#m = target_to_one_hot(torch.tensor(np.array([[0, 1, 3]])))
m = target_to_one_hot(np.array([0, 1, 6]),7)
print(m)
